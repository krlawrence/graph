    ...
    public static void main(String[] args) {
        ...
        List<Map<String, Object>> top =
                g.V().hasLabel("airport").
                      ...
                      project("ap", "num", "city").
                        by("code").by(both("route").count()).by("city").
                      toList();
        ...
        List<Map<String, Object>> topout =
                g.V().hasLabel("airport").
                      ...
                      project("ap", "num", "city").
                        by("code").by(out("route").count()).by("city").
                      toList();
        ...
        List<Map<String, Object>> topin =
                g.V().hasLabel("airport").
                      ...
                      project("ap", "num", "city").
                        by("code").by(in("route").count()).by("city").
                      toList();
        ...
        Map<String, ?> longest =
                g.V().hasLabel("airport").
                      order().by("longest", Order.desc).limit(1).
                      project("ap", "num", "city").
                        by("code").by("longest").by("city").next();

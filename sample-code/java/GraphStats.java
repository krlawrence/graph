...
public class GraphStats {
    public static void main(String[] args) {
        ...
        try {
            g.io("air-routes.graphml").read().with(IO.reader,IO.graphml).iterate();
        } catch (IOException e) {
        ...
        Map<String, ?> longroute =
                g.E().hasLabel("route").
                      ...
                      project("from", "to", "num").
                        by(__.inV().values("city")).
                        by(__.outV().values("city")).
                        by("dist").next();

...
The above process could be very slow if you have a lot of data, in which case you could
use MapReduce to reindex existing data in parallel: https://docs.janusgraph.org/schema/index-management/index-reindexing/.

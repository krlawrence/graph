...
The JanusGraph project was created at the LinuxFoundation in 2016 as a fork of the
open source Titan graph database. Siince then it has become popular amongst graph
database users, and offers a broad feature set, and significant flexibility in terms
of integration with storage backends and external indexing technologies.

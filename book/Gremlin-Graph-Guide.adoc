...
v281-preview, October 7th 2018
//v280 (TP 3.3.3), July 28, 2018
//Sun Oct 07, 2018 14:35:41 CDT
...
properties from an existing vertex.  A technique for doing this is discussed in the
"<<dfwcopy>>" section. Feel free to skip ahead but be aware that the techniques
used in that section have not yet been fully covered so you may want to also take a
look at some other sections along the way.  

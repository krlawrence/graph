...
"<<tranges>>" section.  For the special +++".__"+++ class I have just shown a couple
of examples.  In general you use this prefix when you have noting prior in the query
that you can "dot connect" to.

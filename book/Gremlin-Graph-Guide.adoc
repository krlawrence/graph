...
v279-preview, Apr 12, 2018
//v278 (TP 3.3.1), Mar 28, 2018
// Thu Apr 12, 2018 12:20:32 CDT
...
However, it does show the basic constructs used by the 'match' step also illustrates
using values calculated in one part of a query later on in that same query.

...
v281-preview, November 3rd 2018
//v280 (TP 3.3.3), July 28, 2018
//Sat Nov 03, 2018 09:33:22 CDT
...
essentially that says find me only routes that take at least eight hops to get to
Austin.
...
need to be careful. Noticed how I chose a very specific target for my search. If you
...
time. In many ways the concept of "longest route" can be viewed as an anti pattern.

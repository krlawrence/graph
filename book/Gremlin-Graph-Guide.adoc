...
v278-preview, Mar 12, 2018
// Mon Mar 12, 2018 17:53:24 CDT
...
allows us to do this. In the example below, the number of runways for every airport
in England is queried.  Note that in the returned results there are many duplicate
values.

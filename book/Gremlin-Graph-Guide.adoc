...
the Java 1.8 Pattern class that is documented at https://docs.oracle.com/javase/8/docs/api/java/util/regex/Pattern.html
...
achieve a match in the text being inspected. For example 'pall' would match 'wall'
, 'fall', 'pill' and 'pale'.

...
v277-preview, Feb 9, 2018
// Fri Feb 09, 2018 15:33:57 CST
...
are fine. However, in your environment the defaults mayt not meet your needs. The
...
returned are the two vertices along with their IDs, labels and properties.
...
query, whet is returned is a map where the labels are the keys and the values are the

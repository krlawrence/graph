...
NOTE: In Tinkerpop 3.3 changes to the syntax were made. The previous keywords valueDecr,
valueIncr, keyDecr and keyIncr are now specified using the form 'by(keys,incr)' or
'by(values,decr)' etc. I will update the book to reflect these changes ASAP.

...
v282-preview, October 22nd 2019
// vim: set tw=85 cc=+1 wrap spell redrawtime=20000:
// Tue Oct 22, 2019 18:17:33 CST
...
Achieving this result is a little more complicated that you might expect. The
...
[[doesanyrouteexist]]
Does any route exist between two arirports?
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
multiple routes but is still a very useful pattern to be aware of.

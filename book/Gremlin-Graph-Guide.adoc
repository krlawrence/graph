...
v283-preview, September 2nd 2020
// vim: set tw=85 cc=+1 wrap spell redrawtime=20000:
// Wed Sep 02, 2020 19:37:12 CDT
...
distance between them can be calculated using the
(https://en.wikipedia.org/wiki/Haversine_formula)[Haversine Great Circle Distance
...
Let's take a look at the first query. At first, the number of steps used may look a
bit daunting, but if you work your way through it section by section it's actually

...
v278-preview, Feb 17, 2018
// Sat Feb 17, 2018 12:14:37 CST
...
provided. Any vertex or edge property can be indexed. The example below runs the
query we used in some of our prior tests with and without an index being present for
the 'code' vertex property.
...
overall performance. Hoever, as there are a lot more edges, perhaps creating and edge
...
again. This time you can see that our index has made a big difference.
...
more complex type of comparison predicates..
`
[[olapoltp]]
OLTP vs OLAP
~~~~~~~~~~~~

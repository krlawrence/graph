...
TIP: You can always find the version used for the book and also the most recent data
set in the `sample-data` folder located at
https://github.com/krlawrence/graph/tree/master/sample-data . 
...
connections, none of use is farther removed than six friendship relationships from
anyone else.

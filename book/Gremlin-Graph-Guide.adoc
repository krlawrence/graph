...
v280-preview, July 6, 2018
// v279 (TP 3.3.3), May 31, 2018
// Fri Jul 06, 2018 19:02:47 CDT
...
or edge you can use one of the keywords defined as part of the 'Cardinality' enum

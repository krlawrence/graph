...
'composiste' and 'mixed' indexes as well as the use of external indexing
...
It is strongly recommended that you create indexes for any property keys that you are

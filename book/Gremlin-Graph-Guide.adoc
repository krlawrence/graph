...
v281-preview, November 18th 2018
//v280 (TP 3.3.3), July 28, 2018
//Sun Nov 18, 2018 13:24:57 CST
...
[source,console]
----
sh> gremlin-server.sh start conf/gremlin-server/gremlin-server.yaml
...
[source,console]
----
sh> curl "http://localhost:8182/gremlin?gremlin=g.V().has('code','AUS').valueMap()" 
----
...
//vim: set tw=85 cc=+1 wrap spell redrawtime=10000:

...
v278-preview, Mar 09, 2018
// Fri Mar 09, 2018 12:54:20 CST
...
the standard deviation for the number of outgoing routes in the graph. This time we
get a much bigger number back as the result. This reflects the differing distribution
of routes between major and more minor airports.

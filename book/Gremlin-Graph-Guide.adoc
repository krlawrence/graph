...
v278-preview, Mar 20, 2018
// Tue Mar 20, 2018 10:30:48 CDT
...
As you can see, when we run the query, only detsinations outside the United States
are returned.
...
query but I wanted to show an example of this technique being used. For completeness,

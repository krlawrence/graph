...
If we use 'textContainsPrefix' instead of 'textContains', which looks for whole words
that start with the specified text, we will get some results.
...
Here is what the query will return.

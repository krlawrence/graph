...
not yet seen the 'filter' step that is used below. It is one of the foundational
Gremlin steps that many others such as 'where' build upon. A 'filter' step will only
pass on to the next step in the query incoming elements that meet the criteria
...
[ORD:237,PVG:204,LAX:200,BRU:182,CDG:267,STN:186,JFK:190,DFW:221,LHR:196,MUC:242,DME:216,EWR:183,AMS:272,IST:271,DEN:189,BCN:191,DXB:237,IAH:194,MAD:196,FCO:191,FRA:282,PEK:238,ATL:235,YYZ:183,MAN:186,LGW:204]
----
...
[FRA:282,AMS:272,IST:271,CDG:267,MUC:242,PEK:238,ORD:237,DXB:237,ATL:235,DFW:221,DME:216,PVG:204,LGW:204,LAX:200,LHR:196,MAD:196,IAH:194,BCN:191,FCO:191,JFK:190,DEN:189,STN:186,MAN:186,EWR:183,YYZ:183,BRU:182]
----
...
[ATL,DFW,ORD,LGW,CDG,FRA,DXB,PEK,PVG,AMS,MUC,DME,IST]
----
...
interested in as follows. Only airports with 110 outgoing routes are selected.

[source,groovy]
----
// Which of these airports have 110 outgoing routes?
g.V().hasLabel('airport').
      group().by(out().count()).by('code').next().get(110L)

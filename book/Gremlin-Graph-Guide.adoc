...
v277-preview, Jan 30, 2018
// Tue Jan 30, 2018 09:58:08 CST
...
imported "behind the scenes" and how to access those same capabilities from Java.
...
preference in many cases. For the predicates such as 'neq' and 'within' I have only
listed a few. There is a table of all the available predicates in the "<<tranges>>"
section.  For the special +++".__"+++ class I have just shown one example. In general
you use this prefix when you have noting prior in the query that you can "dot
connect" to.

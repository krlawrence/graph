...
v277-preview, Feb 3, 2018
// Sat Feb 03, 2018 17:59:53 CST
...
[source,console]
----
docker run -d -p 7001:7001 -p 7199:7199 -p 9042:9042 -p 9160:9160 \  <1> <2> <3>
...
TIP: A script called 'janus-cassandra.groovy' is available in the sample-programs

...
JanusGraph allows an external index to be created using a technology such as Apache
Elastic Search or Apache Solr. You would create such an index in cases where you need

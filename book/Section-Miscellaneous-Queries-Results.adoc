...
As you can see, with five hops were were able to reach LHR from 3452 of the 3474
...
As a point of curiosity, we also thought that we'd look the countries where these 
airports were.

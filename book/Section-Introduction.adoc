...
intend to cover any features it offers in this edition of the book. We will only note
that the intention of the TinkerPop Community is for 4.0.0 to have the same semantics
for Gremlin as 3.8.0. As a result, all the Gremlin examples provided in this second
edition of Practical Gremlin will work equally well for both versions.

...
TinkerPop 3.8.0 was released August 2025 and established a wide mix of features and
improvements to Gremlin semantics designed to enhance language consistency. Some of 
these changes do lead to behaviors that break from previous versions of TinkerPop, 

...
that Practical Gremlin was falling behind TinkerPop's continued evolution in a 
significant way. With even bigger sets of changes expected on the horizon with 4.0,
it felt as though it was time to make an organized effort to produce an updated 
Second Edition.
...
- Our journey to explore Apache TinkerPop and Gremlin, concludes with a look at
  useful sources of further reading. We present links to useful web sites where you
...
resources included with this book.

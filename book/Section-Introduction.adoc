...
TinkerPop 3.8.0 was released September 2025 and established a wide mix of features 
...
as an argument who's behavior is now a complement to 'any' and 'all' steps.

...
to be future proof, even if your database is not yet at the TinkerPop 3.5.0 level,
we recommend making these changes to your code as soon as possible.
...
located here: https://github.com/krlawrence/graph/blob/main/sample-code/nested-repeat.groovy
...
At first glance, the 'where' step used above can be confusing. We have included
